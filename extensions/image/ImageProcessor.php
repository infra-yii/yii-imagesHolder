...
class ImageProcessor
{
    ...
    {
        return new ImageProcessor($image, $config);
    }
    ...
    public function __construct($image, $config = NULL)
    {
        ...
        if (!isset(ImageProcessor::$allowed_types[$image_info[2]]))
        ...
        (
            ...
            'height' => $image_info[1],
            'type' => $image_info[2],
            'ext' => ImageProcessor::$allowed_types[$image_info[2]],
    ...
    protected function valid_size($type, & $value)
    {
        ...
        switch ($type) {
            ...
            case 'left':
                ...
                break;
            case 'master':
                if ($value !== ImageProcessor::NONE AND
                    $value !== ImageProcessor::AUTO AND
                        $value !== ImageProcessor::WIDTH AND
                            $value !== ImageProcessor::HEIGHT
                )
                    return FALSE;
                break;
        }
